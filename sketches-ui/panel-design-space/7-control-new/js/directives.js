        ...
        link : function(scope, element, attrs, ctrl) {
            ...
            scope.render = function() {
                ...
                if (data.axes.length == 0 && data.masters.length == 1) {
                    // create slider
                    svg.append('circle').attr('class', 'slider-handle').attr('r', 8).attr('fill', '#000').attr('cx', 110).attr('cy', 10);
                    // create  label
                    svg.append('text').attr('class', 'label-left').attr('x', 10).attr('y', 28).text(function() {
