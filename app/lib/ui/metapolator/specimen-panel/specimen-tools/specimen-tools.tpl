<div class="specimen-tool-set">
    <mtk-specimen-samples class="specimen-tool" mtk-model="model.mixer.specimenSamples"></mtk-specimen-samples>
</div>

<div class="specimen-tool-set">
    <mtk-size-input class="specimen-tool" mtk-model="model.sizes"></mtk-size-input>
    <mtk-size-rope class="specimen-tool" mtk-model="model.sizes" type="type"></mtk-size-rope>
