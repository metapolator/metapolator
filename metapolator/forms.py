...
PointParamExtendedForm = Form(Dropdown('z point', [('', '')], description="zpoint"),
                              Textbox('x', size=12),
                              Textbox('y', size=12),
                              Textbox('line', size=12),
                              Textbox('line into curve', size=12),
                              Textbox('left', size=12),
                              Textbox('right', size=12),
                              Textbox('down', size=12),
                              Textbox('up', size=12),
                              Textbox('direction', size=12),
                              Textbox('left to', size=12),
                              Textbox('right to', size=12),
                              Textbox('down to', size=12),
                              Textbox('up to', size=12),
                              Textbox('direction to', size=12),
                              Textbox('curve tension', size=12),
                              Textbox('shifting', size=12),
#                              Textbox('pointshifted', size=12),
#                              Textbox('angle', size=12),
                              Textbox('pen width', size=12),
                              Textbox('overshoot x-height', size=12),
                              Textbox('undershoot baseline', size=12),
                              Textbox('overshoot capital', size=12),
                              Textbox('overshoot ascender', size=12),
                              Textbox('undershoot descender', size=12),
                              Button('save'))
