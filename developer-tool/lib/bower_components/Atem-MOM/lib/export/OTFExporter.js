...
define([
  ...
  , timer
    ...
    _p.exportGenerator = regeneratorRuntime.mark(function callee$1$0(glyphNames) {
        var master, glyphs, glyph, i, l, style, time, one, total, font, result, otGlyphs, drawFunc, glyphSet, otPen, bPen, pen, bboxPen, bbox;

        return regeneratorRuntime.wrap(function callee$1$0$(context$2$0) {
            while (1) switch (context$2$0.prev = context$2$0.next) {
            case 0:
                master = this._master, total = 0, otGlyphs = [], drawFunc = function(async, segmentPen) {
            ...
            case 5:
                ...
                otPen = new OpenTypePen(new OTPath(), glyphSet), bPen = new BoundsPen(glyphSet), pen = new PointToSegmentPen(otPen), bboxPen = new PointToSegmentPen(bPen);
                glyph = glyphs[i];
