rm $1.log
# mf font.mf
perl mf2pt1.pl --encoding=mtp.enc --comment="Copyright (C) 2014." --family=font --nofixedpitch --fullname="$2" --name=$2 --designsize="10" --rounding="0.00001" --weight=Regular $1.mf
