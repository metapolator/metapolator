...
rm $1.log
# mf font.mf
perl mf2pt1.pl --encoding=mtp.enc --comment="Copyright (C) 2014." --family="${family}" --nofixedpitch --fullname="${family}" --fontversion=${fontversion} --designsize="10" --rounding="0.1" --weight=Regular $metafont.mf
